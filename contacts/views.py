...
def contact(request):
    if request.method == 'POST':
        ...
        messages.success(
            request,
            'Your message has been submitted a realtor will get back to you shortly!'
        )
        ...
        send_mail(
            ...
            'There has been an inquiry for ' + listing + ' by ' + name + ' at ' + email,
            'raokomar@gmail.com',
            [realtor_email, 'raokomar@gmail.com'],
            fail_silently=False,
        )
